...
| :-------------------------------- | :----------------------------------------------------------------------------------------- | :-----: | :-----------------------------------------------------------------------------------------------------------: |
| **Avoid Yandex Turbo**            | Redirects directly to original target page avoiding Yandex Turbo pages (`turbopages.org`). | `3.5.0` |   [Install](https://github.com/Autapomorph/userscripts/releases/latest/download/avoid-yandex-turbo.user.js)   |
...
| **Yandex to DuckDuckGo**          | Adds a DuckDuckGo search button directly into Yandex search results.                       | `2.1.2` |       [Install](https://github.com/Autapomorph/userscripts/releases/latest/download/yandex-ddg.user.js)       |
